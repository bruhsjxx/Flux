...
wget --header="Authorization: Bearer $HF_TOKEN" -c "https://huggingface.co/black-forest-labs/FLUX.2-klein-9B/resolve/main/flux-2-klein-9b.safetensors" -O "$BASE_DIR/checkpoints/flux2Klein_9b.safetensors"
